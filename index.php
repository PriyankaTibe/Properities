                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>We make the process fast, easy and free. We combine innovative technology, personal customer service...</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>The rental flat consist of minimum 3 Rooms, 3 Balconies, 1 Kitchen and above...</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Lying on the listing can get you, customers, initially, however, it will not result in the ultimate sale of the properties.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Consider the investment objectives, risks and charges and expenses carefully before investing.</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <ul>
                                ...
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Real estate offers investors an opportunity to earn a regular income and benefit from capital appreciation of the property.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>We've worked with over 1.4M happy home buyers & sellers

                                            We only recommend the top 5% of agents in your area</p>
									</div>
                                </li>
                            </ul>
                        </div>
